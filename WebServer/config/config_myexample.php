...
$dbuser = "ionel";			// Database user
$dbpass = "ionelpass";			// Database password
...
$system_endAmps = 5;			// The FNDC configured return amps setting
$pv_wattage   = 6000;				// Total wattage of your photo voltaic arrays
$gen_rating   = 2000;				// Total wattage of your generator (or AC IN)
$inverter_max = 6000;			// Total ouput of your inverters (cumulative)
